...
const ProductCrousel = () => {
  ...
  return (
    <div className="flex flex-col items-center  w-full ">
      ...
      <p onClick={() => navigate("/product")} className=" cursor-pointer text-center text-md font-medium overflow-hidden hover:underline">{products[0].name}</p>
      <p className="text-yellow-900 text-xl overflow-hidden">★ ★ ★ ★ ☆</p>
      <p className="text-center text-md font-medium overflow-hidden">Rs. {products[0].price}</p>
      <div className="flex gap-2 items-center justify-center overflow-hidden ">

      <div class="w-9 h-9 rounded-full bg-white flex justify-center items-center hover:border border-black">
            <div class="w-7 h-7 rounded-full bg-blue-gray-500"></div>
          </div>
